...
package com.kp.common.security.utils;

import java.util.Random;

/**
 * A random number generator isolated to the current thread. Like the global
 * {@link Random} generator used by the {@link Math} class,
...
public class ThreadLocalRandom extends Random {
    ...
    // different TLRs in the com.k.common.common case that they are located near
    // each other.
