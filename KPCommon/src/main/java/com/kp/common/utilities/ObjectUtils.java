package com.kp.common.utilities;//package com.k.common.utilities;
//
...
//
//import static DataTypeUtils.getValueFrom;
//import static DataTypeUtils.isPrimitiveOrWrapperType;
//
...
//					setter.set(result, getValueFrom(setter.getParamType(), value));
...
//							try {
//								if (isPrimitiveOrWrapperType(element.getClass())) {
//									list.add(getValueFrom(setter.getComponentType(), element));
...
//		Map<String, Getter> classGetter = new HashMap<String, Getter>();
//		Set<Field> fields = getAllInstancePublicFileds(clazz);
//
//		for (Field field : fields) {
...
//					if (element == null) {
//						list.add(null);
//					} else if (isPrimitiveOrWrapperType(element.getClass())) {
//						list.add(element);
...
//			return null;
//		}
//		if (isPrimitiveOrWrapperType(obj.getClass())) {
...
//					if (isPrimitiveOrWrapperType(((Object) entry.getValue()).getClass())) {
